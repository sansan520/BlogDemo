...
namespace Blog.Infrastructure.PropertyMappingServices
{
    public class PropertyMappingContainer : IPropertyMappingContainer
    {
        ...
        public IPropertyMapping Resolve<TSource, TDestination>() where TDestination : IEntityBase
        {
        ...
        public bool ValidateMappingExistsFor<TSource, TDestination>(string fields) where TDestination : IEntityBase
        {
